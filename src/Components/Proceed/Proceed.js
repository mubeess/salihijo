...
export default function Proceed() {
    ...
    const handleChange = (event) => {
      ...
      useEffect(()=>{
       fetch('https://samsa-salihijo.herokuapp.com/admin/get-current-term').
       then(res=>{
         res.json()
         .then(data=>{
          notification.open({
    ...
    return (
     ...
     <Button onClick={()=>{
       ...
       if (checked) {
        fetch('https://samsa-salihijo.herokuapp.com/admin/set-new-term',{
          method:'POST',
          headers:{
...
entered successfuly
     ...
     <Button onClick={()=>{
       ...
       if (checkedSession) {
        ...
        fetch('https://samsa-salihijo.herokuapp.com/admin/set-new-session',{
          method:'POST',
          headers:{
          "Content-Type":'application/json'
          },
