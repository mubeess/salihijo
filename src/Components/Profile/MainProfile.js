...
export default function MainProfile() {
  ...
  useEffect(()=>{
    ...
    let appImage=`https://samsa-salihijo.herokuapp.com/${myRealImage}`;
    ...
    return (
        ...
        {/* <img className="profile-pic" src='https://samsa-salihijo.herokuapp.com/public/images/musty-avatar.jpg' /> */}
  ...
  if (!isJpgOrPng) {
    ...
    action={`https://samsa-salihijo.herokuapp.com/admin/set-profile-pic/?id=${JSON.parse(localStorage.getItem('user')).user._id}`}
    name='profile_pic'
    method='PUT'
    ...
    onChange={(info)=>{
      ...
      if (info.file.status === 'done') {
        ...
        const myRealImage=myImage.splice(1,2).join('/')
       const  newAppImage=`https://samsa-salihijo.herokuapp.com/${myRealImage}`;
        ...
        <div  className="change-password-section">
         ...
         <Button onClick={()=>{
             ...
             return   message.error('Password does not Match!!!')
                ...
                fetch(`https://samsa-salihijo.herokuapp.com/${urlToPush}/change-password/${JSON.parse(localStorage.getItem('user')).user._id}`,{
                    method:'POST',
                    headers:{
