...
const useStyles = makeStyles((theme)=>(
  {
    butt: {
      boxShadow: '0 0px 0px 2px ##ADD8E6',
      border: '0.2px solid ##ADD8E6',
      color:'##ADD8E6'
    },
    root:{
      '&:hover': {
...
<Button onClick={()=>{
  ...
  fetch('https://samsa-salihijo.herokuapp.com/admin/login',{
    method:'POST',
    headers:{
...
}}  className={classes.butt}  style={{marginLeft:'auto',marginTop:'30px',marginRight:'40px'}} variant='outlined' color='primary'>
        Login
      </Button>
                 </div>
             </div>
