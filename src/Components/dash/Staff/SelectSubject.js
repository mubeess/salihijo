...
function SelectSubject(props) {
  ...
  const urlToPush=isAdmin||isExamOfficer?'https://samsa-salihijo.herokuapp.com/admin/get-all-admin-curriculum':`https://samsa-salihijo.herokuapp.com/teacher/teacher-subjects/?id=${JSON.parse(localStorage.getItem('user')).user._id}`
...
{/* <TextField
    ...
    // console.log(myObj)
     ...
     fetch('https://samsa-salihijo.herokuapp.com/teacher/fetch-students-result',{
      method:'POST',
      headers:{
