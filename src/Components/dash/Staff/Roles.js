      ...
      .then(data=>{
        ...
        .then(res=>{
          ...
          .then(data=>{
            ...
            fetch('https://samsa-salihijo.herokuapp.com/admin/get-every-class')
            .then(res=>{
              res.json()
              .then(data=>{
                console.log("+++++++",data)
...
console.log(myObj)
handleToggle()
fetch(`https://samsa-salihijo.herokuapp.com/admin/set-role/?id=${staff}`,{
  method:'PUT',
  headers:{
        ...
        <Typography style={{
         ...
         <Typography style={{
          ...
          <Button onClick={()=>{
            ...
            fetch(`https://samsa-salihijo.herokuapp.com/admin/set-role/?id=${staf._id}`,{
              method:'PUT',
              headers:{
                "Content-Type":'application/json'
              },
