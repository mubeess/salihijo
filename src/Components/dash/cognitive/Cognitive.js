...
const StyledTableCell = withStyles((theme) => ({
 ...
 function Cognitive(props) {
  ...
  useEffect(()=>{
    ...
    fetch(`https://samsa-salihijo.herokuapp.com/admin/get-all-staff`)
    .then(res=>{
      res.json()
      .then(data=>{
    ...
    return (
    ...
    
       {
            ...
            <FormControl style={{width:'40%'}}  variant="outlined" className={classes.formControl}>
              ...
              <Select
               onChange={(e)=>{
                ...
                fetch(`https://samsa-salihijo.herokuapp.com/admin/get-all-classes/?section=${e.target.value}`)
                .then(res=>{
                  res.json()
                  .then(data=>{
                   console.log(data)
          ...
          <div className='personal'>
          <Button onClick={()=>{
            fetch(`https://samsa-salihijo.herokuapp.com/admin/get-all-student-according-to-class-category/?currentClass=${classs}&&category=${category}`)
                .then(res=>{
                  res.json()
                  .then(data=>{
                    setAllStudents(data.students)
                   console.log(data)
                   fetch(`https://samsa-salihijo.herokuapp.com/admin/get-all-cognitive-item/`)
                   .then(res=>{
                     res.json()
                     .then(data=>{
                      setCognitive([])
