...
useEffect(()=>{
  fetch(`https://samsa-salihijo.herokuapp.com/admin/get-all-student`)
  .then(res=>{
    res.json()
    .then(data=>{
              ...
              <StyledTableRow key={ind}>
                ...
                <ViewArrayRounded onClick={()=>{
                 ...
                 <DeleteForeverRounded onClick={()=>{
                   ...
                   if (confirmed) {
                    fetch(`https://samsa-salihijo.herokuapp.com/admin/remove-student/?id=${userId}&&username=${row.username}`,{
                      method:'DELETE',
                      headers:{
                 ...
                 }} style={{color:'red',marginRight:'10px',cursor:'pointer'}}></DeleteForeverRounded>
                 {
                   row.suspend==true?(
                    <Button onClick={()=>{
                     ...
                     if(confirmed==true) {
                      fetch(`https://samsa-salihijo.herokuapp.com/admin/suspend-a-student/?username=${row.username}&suspend=false`,{
                        method:'PUT',
                        headers:{
                          "Content-Type":'application/json'
                        }
                    ...
                    <Button onClick={()=>{
                     ...
                     if(confirmed==true) {
                      fetch(`https://samsa-salihijo.herokuapp.com/admin/suspend-a-student/?username=${row.username}&suspend=true`,{
                        method:'PUT',
                        headers:{
                          "Content-Type":'application/json'
                        }
