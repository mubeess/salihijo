 ...
 function Verify(props) {
  ...
  const id = openn ? 'simple-popover' : undefined;
    ...
    useEffect(() => {
      ...
      // })
      const payments=[]
      fetch(`https://samsa-salihijo.herokuapp.com/admin/get-payment-type`)
          .then(res=>{
            res.json()
            .then(data=>{
    ...
    return (
        ...
        <Selects
         onChange={(e)=>{
          ...
          fetch(`https://samsa-salihijo.herokuapp.com/admin/get-all-student-according-to-section/?section=${e.target.value}`)
          .then(res=>{
            res.json()
            .then(data=>{
...
<Select
  ...
  />
   ...
   <Button onClick={()=>{
         ...
         fetch(`https://samsa-salihijo.herokuapp.com/admin/verify-payment/?username=${studentId}`,{
          method:'POST',
          headers:{
...
<TextField onChange={(e)=>{
      ...
      <Button onClick={()=>{
        ...
        fetch('https://samsa-salihijo.herokuapp.com/admin/add-payment',{
          method:'POST',
          headers:{
            "Content-Type":'application/json'
          },
