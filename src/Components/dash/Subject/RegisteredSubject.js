...
export default function RegisterdSubject(){
  ...
  useEffect(()=>{
    fetch('https://samsa-salihijo.herokuapp.com/admin/get-all-subject')
    .then(res=>{
      res.json()
      .then(data=>{
...
<Fab onClick={()=>{
  setOpen(true)
  if (allData.length==0) {
    fetch('https://samsa-salihijo.herokuapp.com/admin/get-all-curriculum')
  .then(res=>{
    res.json()
    .then(data=>{
                ...
                <StyledTableCell align="right">
                 ...
                 <DeleteForeverRounded onClick={()=>{
                   ...
                   if(isConfirmed==true){
                    ...
                    fetch(`https://samsa-salihijo.herokuapp.com/admin/delete-single-subject`,{
                      method:'DELETE',
                      headers:{
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    {dat.subject.map((sbj,ind)=>(
                      <h4 style={{
                       ...
                       if(isConfirmed==true){
                        ...
                        setIsLoading(true)
                        fetch(`https://samsa-salihijo.herokuapp.com/admin/delete-subject`,{
                          method:'DELETE',
                          headers:{
                            "Content-Type":'application/json'
                          },
                   ...
                   if(isConfirmed==true){
                    ...
                    fetch(`https://samsa-salihijo.herokuapp.com/admin/delete-single-curriculum`,{
                      method:'DELETE',
                      headers:{
                        "Content-Type":'application/json'
                      },
